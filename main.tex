...
\textbf{Multi-Process Control System with Triple Modular Redundancy (C)}

During my personal time, I developed a versatile control system featuring sensors, actuators, and controllers configured in an open-loop setup. By incorporating a flag-based mechanism, the system seamlessly transitions to a Triple Modular Redundancy (TMR) scheme, enhancing reliability through sensor replication and data filtering. Each system component is mapped to an independent Linux process, facilitating modularization and communication through abstracted channels, currently implemented via Linux message queues. Notably, the system boasts flexibility in control laws, allowing for seamless swapping without necessitating full code recompilation. This project showcases my proficiency in system design, flexibility in implementation, and commitment to robust, maintainable solutions.

\textbf{GNSS Synchronisation \& Bistatic Passive Radar (VHDL, C)}

I initiated a collaboration with a defense company to contribute to the development of a bistatic passive radar. In this capacity, I tackled the challenge of identifying the strongest Doppler frequency among satellite signals. Utilizing innovative techniques, I divided the task into two subblocks, optimizing resource usage by computing signal magnitudes on-the-fly. Leveraging Xilinx platforms, I integrated the Xilinx DDS compiler for flexible signal generation and devised a comprehensive testbench. Furthermore, I engineered Linux drivers for a software proof of concept, demonstrating functionality to stakeholders. Through meticulous error analysis and documentation, I ensured minimal discrepancies between the developed IP core and provided sample data. This project underscores my ability to deliver impactful solutions and collaborate effectively in complex technical environments.

\textbf{Arithmetic Logic Unit Implementation (VHDL)}

As a leader and integral team member in a university project, I spearheaded the design and implementation of an Arithmetic Logic Unit (ALU) on a Xlinx Spartan 3E FPGA. My responsibilities ranged from project supervision to the development of critical components. Through careful evaluation and selection of optimal solutions, I demonstrated expertise in hardware design and project management. Effective communication of our progress and findings to stakeholders further underscored my ability to deliver impactful results in complex technical projects. This experience significantly enhanced my skills in hardware design, project management, and communication, positioning me as a versatile and capable professional in the field.
