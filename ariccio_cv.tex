...
\keyskills{
    \begin{skilltable}
        ...
        \skillitem
        {\textbf{(MP)SoC/MCU}: Zynq UltraScale+ XCZU9EG MPSoC, Zynq-7010 SoC, STM32F401C-DISCO MCU, STM32F401RE MCU, i.MX 6Solo MCU, Raspberry Pi 4B MCU}
        \skillitem
        {\textbf{FPGA/CPU}: Spartan-3E XC3S1200E FPGA, PolarFire FPGA, proASIC3e A3PE3000-FG484I FPGA, RTAX-S/SL RTAX2000S FPGA, ARM Cortex-A53/A72/A9, ARM Cortex-R5F, ARM Cortex-M4}
        \skillitem
        {\textbf{Protocols}: I2C, SPI, U(S)ART, AMBA AHB/APB, AMBA AXI}
        \skillitem
        {\textbf{Operative Systems}: Linux, Linux RT, freeRTOS, RTEMS, Zephyr}
        \skillitem
...
\begin{twenty} % Environment for a list with descriptions
    ...
    \twentyitem
        ...
        {Medical Company, Munich, \textbf{Germany}}
        {}
        {
            \vspace{2 mm}
            \underline{\textbf{Project}: software integration \& validation for medical device}

            \vspace{2 mm}
            \begin{itemize}
                \item IEC 62304 Class C compliant software integration and validation for Zynq UltraScale+ SoCs and Spartan FPGAs. Maintaining software and configuration consistency across 7 prototypes ensuring correct behaviour after updates, configuration changes, or failures.
                \item Design and PowerShell development of automation scripts to support and automate error-prone deployment workflows. Unit tests in a Docker-based environment. Integration tests on real device.
                \item Black box system-level tests. Investigated failed test cases by collecting data for analysis and generating defect reports with reproduction steps, logs, and relevant embedded debugging information.
            \end{itemize}

            \vspace{2 mm}
            \textbf{\textit{Skills}}: IEC 62304, Zynq UltraScale+ XCZU9EG, QNX, RTOS, FPGA, Xilinx, MicroBlaze, PowerShell, Docker, V-model, System Integration.
        }\\
    \twentyitem
        {Dec 2023 -}
        {Dec 2024}
        ...
        {
            \vspace{2 mm}
            Took time away from professional work to focus on early parenthood and family responsibilities.
        }\\
    \twentyitem
        {Nov 2023 -}
        {May 2023}
